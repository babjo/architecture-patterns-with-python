...
* [이 문서에 대해](README.md)
* [Chapter 0. 도입](chapter0/README.md)

### Part 1. 도메인 모델링을 지원하는 아키텍처 구축
* [Chapter 1. 도메인 모델링](chapter1/README.md)
* [Chapter 2. 저장소 패턴](chapter2/README.md)
* [Chapter 3. 막간: 결합과 추상화](chapter3/README.md)
...
### Part 2. 이벤트 기반 아키텍처
* [Chapter 8. 이벤트와 메시지 버스](chapter8/README.md)
