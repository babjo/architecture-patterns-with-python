...
from chapter9.src.src.allocation.adapters import repository
from chapter9.src.src.allocation.domain import events
from chapter9.src.src.allocation.service_layer import handlers, messagebus, unit_of_work
...
class TestAllocate:
    ...
    def test_sends_email_on_out_of_stock_error(self):
        ...
        with mock.patch("chapter9.src.src.allocation.adapters.email.send_mail") as mock_send_mail:
            messagebus.handle(
